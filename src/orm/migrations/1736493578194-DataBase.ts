...
export class DataBase1736493578194 implements MigrationInterface {
    name = 'DataBase1736493578194'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`activity_log\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(100) NOT NULL, \`isSend\` tinyint NOT NULL, \`userId\` int NULL, \`boardId\` int NULL, \`workspaceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
